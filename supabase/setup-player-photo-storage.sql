-- Run this in the Supabase SQL Editor before uploading player photos from the admin UI.
-- It creates a public bucket for player photos and allows only admin users to upload/change files.
